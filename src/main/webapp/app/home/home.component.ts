...
export default class HomeComponent {
  generateBonAchat(): void {
    ...
    doc.text(
      "Priere de bien vouloir assurer a l'Agence pour la Promotion de l'Emploi des Jeunes (APEJ) les services ci-dessous",
      10,
      85,
      { maxWidth: 190 },
    );
    ...
    const tableRows = [
      [
        "Lait en poudre boite moyenne NIDO (carton de 12)",
        "30",
        "130 000",
        "3 900 000",
      ],
      ...
      [
        "Eau minérale petite bouteille 33 cl (carton 24)",
        "186",
        "1 000",
        "186 000",
      ],
    ...
    let TTC = THT + TVA;
    doc.text("" + THT, pageWidth - marginLeft - 6, yPosition, {
      align: "right",
    });
    doc.text("" + TVA, pageWidth - marginLeft - 6, yPosition + 5, {
      align: "right",
    });
    doc.text("" + TVA40, pageWidth - marginLeft - 6, yPosition + 10, {
      align: "right",
    });
    doc.text("" + TTC, pageWidth - marginLeft - 6, yPosition + 15, {
      align: "right",
    });
    ...
    let text =
      "Quatorze millions neuf cent soixante-quinze mille trois cent quatre-vingts Francs CFA";
