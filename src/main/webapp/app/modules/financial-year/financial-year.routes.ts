...
const financialYearRoute: Routes = [
  {
    path: "",
    loadComponent: () =>
      import("./list/financial-year.component").then(
        (m) => m.FinancialYearComponent,
      ),
    data: {
      defaultSort: `theYear,${ASC}`,
    },
  ...
  },
  {
    path: ":id/view",
    loadComponent: () =>
      import("./detail/financial-year-detail.component").then(
  ...
  },
  {
    path: "new",
    loadComponent: () =>
      import("./update/financial-year-update.component").then(
        (m) => m.FinancialYearUpdateComponent,
      ),
    resolve: {
      financialYear: FinancialYearResolve,
    },
