...
export class ArticleComponent implements OnInit {
  ...
  trackId = (item: IArticle): number =>
    this.articleService.getArticleIdentifier(item);
  ...
  openCreateModal(): void {
    ...
    modalRef.componentInstance.article = undefined; // Pour la création
    modalRef.closed
      .pipe(
  ...
  openEditModal(article: IArticle): void {
    ...
    modalRef.componentInstance.article = article; // Envoie l'objet complet au modal
    modalRef.closed
      .pipe(
  ...
  delete(article: IArticle): void {
    const modalRef = this.modalService.open(ArticleDeleteDialogComponent, {
      size: "lg",
      backdrop: "static",
    });
