...
import {
  ArticleFormGroup,
  ArticleFormService,
} from "app/entities/article/update/article-form.service";
...
@Component({
  ...
  templateUrl: "./article-update-modal.component.html",
  styleUrl: "./article-update-modal.component.css",
