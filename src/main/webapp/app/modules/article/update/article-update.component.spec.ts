...
import { ArticleFormService } from "app/entities/article/update/article-form.service";
...
describe("Article Management Update Component", () => {
  ...
  describe("ngOnInit", () => {
    it("Should call Chapter query and add missing value", () => {
      ...
      jest
        .spyOn(chapterService, "query")
        .mockReturnValue(of(new HttpResponse({ body: chapterCollection })));
      const additionalChapters = [chapter];
      const expectedCollection: IChapter[] = [
        ...additionalChapters,
        ...chapterCollection,
      ];
      jest
        .spyOn(chapterService, "addChapterToCollectionIfMissing")
      ...
      expect(
        chapterService.addChapterToCollectionIfMissing,
    ...
    it("Should call Recipe query and add missing value", () => {
      ...
      jest
        .spyOn(recipeService, "query")
        .mockReturnValue(of(new HttpResponse({ body: recipeCollection })));
      const additionalRecipes = [...recipes];
      const expectedCollection: IRecipe[] = [
        ...additionalRecipes,
        ...recipeCollection,
      ];
      jest
        .spyOn(recipeService, "addRecipeToCollectionIfMissing")
        .mockReturnValue(expectedCollection);
    ...
    it("Should call Expense query and add missing value", () => {
      ...
      jest
        .spyOn(expenseService, "query")
        .mockReturnValue(of(new HttpResponse({ body: expenseCollection })));
      const additionalExpenses = [...expenses];
      const expectedCollection: IExpense[] = [
        ...additionalExpenses,
        ...expenseCollection,
      ];
      jest
        .spyOn(expenseService, "addExpenseToCollectionIfMissing")
        .mockReturnValue(expectedCollection);
      ...
      expect(
        expenseService.addExpenseToCollectionIfMissing,
      ).toHaveBeenCalledWith(
        expenseCollection,
  ...
  describe("save", () => {
    ...
    it("Should call create service on save for new entity", () => {
      ...
      const article = { id: 24128 };
      jest
        .spyOn(articleFormService, "getArticle")
  ...
  describe("Compare relationships", () => {
    describe("compareChapter", () => {
      it("Should forward to chapterService", () => {
        ...
        expect(chapterService.compareChapter).toHaveBeenCalledWith(
          entity,
          entity2,
        );
      });
    ...
    describe("compareRecipe", () => {
      it("Should forward to recipeService", () => {
        ...
        expect(recipeService.compareRecipe).toHaveBeenCalledWith(
          entity,
          entity2,
        );
      });
    ...
    describe("compareExpense", () => {
      it("Should forward to expenseService", () => {
        ...
        expect(expenseService.compareExpense).toHaveBeenCalledWith(
          entity,
          entity2,
        );
      });
