...
import {
  ...
  SubTitleService,
} from "../service/sub-title.service";
import { SubTitleDeleteDialogComponent } from "../delete/sub-title-delete-dialog.component";
import { ISubTitle } from "app/entities/sub-title/sub-title.model";
import { SubTitleUpdateComponent } from "../update/sub-title-update.component";

@Component({
  selector: "jhi-sub-title",
...
export class SubTitleComponent implements OnInit {
  ...
  trackId = (item: ISubTitle): number =>
    this.subTitleService.getSubTitleIdentifier(item);
  ...
  openCreateModal(): void {
    const modalRef = this.modalService.open(SubTitleUpdateComponent, {
      size: "lg",
      backdrop: "static",
    });
    modalRef.componentInstance.subTitle = undefined; // Pour la création
    modalRef.closed
      .pipe(
  ...
  openEditModal(subTitle: ISubTitle): void {
    const modalRef = this.modalService.open(SubTitleUpdateComponent, {
      size: "lg",
      backdrop: "static",
    });
    modalRef.componentInstance.subTitle = subTitle; // Envoie l'objet complet au modal
    modalRef.closed
      .pipe(
  ...
  delete(subTitle: ISubTitle): void {
    const modalRef = this.modalService.open(SubTitleDeleteDialogComponent, {
      size: "lg",
      backdrop: "static",
    });
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.subTitles.set(dataFromBody);
  }
