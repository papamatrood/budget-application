...
describe("MetricsComponent", () => {
  ...
  describe("refresh", () => {
    it("should call refresh on init", () => {
      ...
      const threadDump = {
        threads: [{ threadName: "thread 1" } as Thread],
      } as ThreadDump;
      ...
      expect(
        changeDetector.constructor.prototype.markForCheck,
      ).toHaveBeenCalled();
    });
  });
  ...
  describe("metricsKeyExistsAndObjectNotEmpty", () => {
    it("should check that metrics key exists and is not empty", () => {
      ...
      // WHEN
      const garbageCollectorKeyExistsAndNotEmpty =
        comp.metricsKeyExistsAndObjectNotEmpty("garbageCollector");
    ...
    it("should check that metrics key is empty", () => {
      ...
      // WHEN
      const garbageCollectorKeyEmpty =
        comp.metricsKeyExistsAndObjectNotEmpty("garbageCollector");
