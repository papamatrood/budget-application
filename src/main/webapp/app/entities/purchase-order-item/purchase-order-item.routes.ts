...
const purchaseOrderItemRoute: Routes = [
  {
    path: "",
    loadComponent: () =>
      import("./list/purchase-order-item.component").then(
        (m) => m.PurchaseOrderItemComponent,
      ),
    data: {
      defaultSort: `id,${ASC}`,
    },
  ...
  },
  {
    path: ":id/view",
    loadComponent: () =>
      import("./detail/purchase-order-item-detail.component").then(
  ...
  },
  {
    path: "new",
    loadComponent: () =>
      import("./update/purchase-order-item-update.component").then(
        (m) => m.PurchaseOrderItemUpdateComponent,
      ),
    resolve: {
      purchaseOrderItem: PurchaseOrderItemResolve,
    },
