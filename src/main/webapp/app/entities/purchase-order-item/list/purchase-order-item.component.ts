...
} from "../service/purchase-order-item.service";
...
export class PurchaseOrderItemComponent implements OnInit {
  ...
  protected readonly purchaseOrderItemService = inject(
    PurchaseOrderItemService,
  );
  ...
  trackId = (item: IPurchaseOrderItem): number =>
    this.purchaseOrderItemService.getPurchaseOrderItemIdentifier(item);
