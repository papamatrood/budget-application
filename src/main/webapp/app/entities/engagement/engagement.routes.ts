...
const engagementRoute: Routes = [
  {
    path: "",
    loadComponent: () =>
      import("./list/engagement.component").then((m) => m.EngagementComponent),
    data: {
      defaultSort: `id,${ASC}`,
    },
  ...
  },
  {
    path: ":id/view",
    loadComponent: () =>
      import("./detail/engagement-detail.component").then(
  ...
  },
  {
    path: "new",
    loadComponent: () =>
      import("./update/engagement-update.component").then(
        (m) => m.EngagementUpdateComponent,
      ),
    resolve: {
      engagement: EngagementResolve,
    },
