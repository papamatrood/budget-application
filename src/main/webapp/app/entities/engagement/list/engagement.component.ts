...
export class EngagementComponent implements OnInit {
  ...
  trackId = (item: IEngagement): number =>
    this.engagementService.getEngagementIdentifier(item);
  ...
  delete(engagement: IEngagement): void {
    const modalRef = this.modalService.open(EngagementDeleteDialogComponent, {
      size: "lg",
      backdrop: "static",
    });
