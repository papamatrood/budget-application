 ...
 */
type EngagementFormGroupInput =
  | IEngagement
  | PartialWithRequiredKeyOf<NewEngagement>;

/**
 * Type that converts some properties for forms.
 */
type FormValueOf<T extends IEngagement | NewEngagement> = Omit<
  T,
  "engagementDate"
> & {
...
type EngagementFormGroupContent = {
  ...
  amountProposedCommitment: FormControl<
    EngagementFormRawValue["amountProposedCommitment"]
  >;
  headDaf: FormControl<EngagementFormRawValue["headDaf"]>;
  financialController: FormControl<
    EngagementFormRawValue["financialController"]
  >;
...
export class EngagementFormService {
  createEngagementFormGroup(
    engagement: EngagementFormGroupInput = { id: null },
  ): EngagementFormGroup {
    ...
    return new FormGroup<EngagementFormGroupContent>({
      ...
      amountProposedCommitment: new FormControl(
        engagementRawValue.amountProposedCommitment,
      ),
      headDaf: new FormControl(engagementRawValue.headDaf),
      financialController: new FormControl(
        engagementRawValue.financialController,
      ),
  ...
  getEngagement(form: EngagementFormGroup): IEngagement | NewEngagement {
    return this.convertEngagementRawValueToEngagement(
      form.getRawValue() as EngagementFormRawValue | NewEngagementFormRawValue,
    );
  }

  resetForm(
    form: EngagementFormGroup,
    engagement: EngagementFormGroupInput,
  ): void {
    const engagementRawValue = this.convertEngagementToEngagementRawValue({
      ...this.getFormDefaults(),
      ...engagement,
  ...
  private convertEngagementToEngagementRawValue(
    ...
    | EngagementFormRawValue
    | PartialWithRequiredKeyOf<NewEngagementFormRawValue> {
    return {
      ...engagement,
      engagementDate: engagement.engagementDate
        ? engagement.engagementDate.format(DATE_TIME_FORMAT)
        : undefined,
    };
  }
}
