...
import engagementResolve from './engagement-routing-resolve.service';

describe('Engagement routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: EngagementService;
  let resultEngagement: IEngagement | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IEngagement returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        engagementResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultEngagement).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IEngagement>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
