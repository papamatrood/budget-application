...
export class DecisionComponent implements OnInit {
  ...
  protected readonly decisionService = inject(DecisionService);
  protected readonly activatedRoute = inject(ActivatedRoute);
  protected readonly sortService = inject(SortService);
  protected modalService = inject(NgbModal);
  protected ngZone = inject(NgZone);

  trackId = (item: IDecision): number =>
    this.decisionService.getDecisionIdentifier(item);
  ...
  delete(decision: IDecision): void {
    const modalRef = this.modalService.open(DecisionDeleteDialogComponent, {
      size: "lg",
      backdrop: "static",
    });
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.decisions.set(dataFromBody);
  }
