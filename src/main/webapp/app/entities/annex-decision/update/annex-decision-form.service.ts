 ...
 */
type AnnexDecisionFormGroupInput =
  | IAnnexDecision
  | PartialWithRequiredKeyOf<NewAnnexDecision>;
...
export class AnnexDecisionFormService {
  createAnnexDecisionFormGroup(
    annexDecision: AnnexDecisionFormGroupInput = { id: null },
    ...
    return new FormGroup<AnnexDecisionFormGroupContent>({
      ...
      creditsAlreadyOpen: new FormControl(
        annexDecisionRawValue.creditsAlreadyOpen,
      ),
  ...
  getAnnexDecision(
    form: AnnexDecisionFormGroup,
  ): IAnnexDecision | NewAnnexDecision {
    return form.getRawValue() as IAnnexDecision | NewAnnexDecision;
  }

  resetForm(
    form: AnnexDecisionFormGroup,
    annexDecision: AnnexDecisionFormGroupInput,
  ): void {
    const annexDecisionRawValue = {
      ...this.getFormDefaults(),
      ...annexDecision,
