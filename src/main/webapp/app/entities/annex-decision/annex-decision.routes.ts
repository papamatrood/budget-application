...
const annexDecisionRoute: Routes = [
  {
    path: "",
    loadComponent: () =>
      import("./list/annex-decision.component").then(
        (m) => m.AnnexDecisionComponent,
      ),
    data: {
      defaultSort: `id,${ASC}`,
    },
  ...
  },
  {
    path: ":id/view",
    loadComponent: () =>
      import("./detail/annex-decision-detail.component").then(
  ...
  },
  {
    path: "new",
    loadComponent: () =>
      import("./update/annex-decision-update.component").then(
        (m) => m.AnnexDecisionUpdateComponent,
      ),
    resolve: {
      annexDecision: AnnexDecisionResolve,
    },
