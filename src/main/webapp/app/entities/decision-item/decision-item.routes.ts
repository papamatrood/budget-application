...
const decisionItemRoute: Routes = [
  {
    path: "",
    loadComponent: () =>
      import("./list/decision-item.component").then(
        (m) => m.DecisionItemComponent,
      ),
    data: {
      defaultSort: `id,${ASC}`,
    },
  ...
  },
  {
    path: ":id/view",
    loadComponent: () =>
      import("./detail/decision-item-detail.component").then(
  ...
  },
  {
    path: "new",
    loadComponent: () =>
      import("./update/decision-item-update.component").then(
        (m) => m.DecisionItemUpdateComponent,
      ),
    resolve: {
      decisionItem: DecisionItemResolve,
    },
