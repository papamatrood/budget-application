 ...
 */
type PurchaseOrderFormGroupInput =
  | IPurchaseOrder
  | PartialWithRequiredKeyOf<NewPurchaseOrder>;
...
type PurchaseOrderFormGroupContent = {
  ...
  nameOfTheMinistry: FormControl<
    PurchaseOrderFormRawValue["nameOfTheMinistry"]
  >;
  orderNumber: FormControl<PurchaseOrderFormRawValue["orderNumber"]>;
  orderDate: FormControl<PurchaseOrderFormRawValue["orderDate"]>;
  totalAmountWithoutTax: FormControl<
    PurchaseOrderFormRawValue["totalAmountWithoutTax"]
  >;
  ...
  totalAmountWithTax: FormControl<
    PurchaseOrderFormRawValue["totalAmountWithTax"]
  >;
  authExpenditureNumber: FormControl<
    PurchaseOrderFormRawValue["authExpenditureNumber"]
  >;
  allocatedCredits: FormControl<PurchaseOrderFormRawValue["allocatedCredits"]>;
  committedExpenditures: FormControl<
    PurchaseOrderFormRawValue["committedExpenditures"]
  >;
...
export class PurchaseOrderFormService {
  createPurchaseOrderFormGroup(
    purchaseOrder: PurchaseOrderFormGroupInput = { id: null },
  ): PurchaseOrderFormGroup {
    const purchaseOrderRawValue =
      this.convertPurchaseOrderToPurchaseOrderRawValue({
    ...
    return new FormGroup<PurchaseOrderFormGroupContent>({
      ...
      nameOfTheMinistry: new FormControl(
        purchaseOrderRawValue.nameOfTheMinistry,
        {
          validators: [Validators.required],
        },
      ),
      ...
      totalAmountWithoutTax: new FormControl(
        purchaseOrderRawValue.totalAmountWithoutTax,
      ),
      ...
      totalAmountWithTax: new FormControl(
        purchaseOrderRawValue.totalAmountWithTax,
      ),
      authExpenditureNumber: new FormControl(
        purchaseOrderRawValue.authExpenditureNumber,
      ),
      allocatedCredits: new FormControl(purchaseOrderRawValue.allocatedCredits),
      committedExpenditures: new FormControl(
        purchaseOrderRawValue.committedExpenditures,
      ),
  ...
  getPurchaseOrder(
    form: PurchaseOrderFormGroup,
  ): IPurchaseOrder | NewPurchaseOrder {
    return this.convertPurchaseOrderRawValueToPurchaseOrder(
      form.getRawValue() as
        | PurchaseOrderFormRawValue
        | NewPurchaseOrderFormRawValue,
    );
  }

  resetForm(
    form: PurchaseOrderFormGroup,
    purchaseOrder: PurchaseOrderFormGroupInput,
  ): void {
    const purchaseOrderRawValue =
      this.convertPurchaseOrderToPurchaseOrderRawValue({
        ...this.getFormDefaults(),
  ...
  private convertPurchaseOrderToPurchaseOrderRawValue(
    purchaseOrder:
      | IPurchaseOrder
      | (Partial<NewPurchaseOrder> & PurchaseOrderFormDefaults),
  ):
    | PurchaseOrderFormRawValue
    | PartialWithRequiredKeyOf<NewPurchaseOrderFormRawValue> {
    return {
      ...purchaseOrder,
      orderDate: purchaseOrder.orderDate
        ? purchaseOrder.orderDate.format(DATE_TIME_FORMAT)
        : undefined,
    };
  }
}
