...
const purchaseOrderRoute: Routes = [
  {
    path: "",
    loadComponent: () =>
      import("./list/purchase-order.component").then(
  ...
  },
  {
    path: ":id/view",
    loadComponent: () =>
      import("./detail/purchase-order-detail.component").then(
  ...
  },
  {
    path: "new",
    loadComponent: () =>
      import("./update/purchase-order-update.component").then(
        (m) => m.PurchaseOrderUpdateComponent,
      ),
    resolve: {
      purchaseOrder: PurchaseOrderResolve,
    },
