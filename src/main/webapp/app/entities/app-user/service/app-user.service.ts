...
type RestOf<T extends IAppUser | NewAppUser> = Omit<T, 'lastDateUpdate' | 'dateCreated' | 'birthDate'> & {
...
export class AppUserService {
  ...
  protected convertDateFromServer(restAppUser: RestAppUser): IAppUser {
    return {
      ...restAppUser,
      lastDateUpdate: restAppUser.lastDateUpdate ? dayjs(restAppUser.lastDateUpdate) : undefined,
      dateCreated: restAppUser.dateCreated ? dayjs(restAppUser.dateCreated) : undefined,
