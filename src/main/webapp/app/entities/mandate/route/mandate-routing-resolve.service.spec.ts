...
import mandateResolve from './mandate-routing-resolve.service';

describe('Mandate routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: MandateService;
  let resultMandate: IMandate | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IMandate returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        mandateResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultMandate).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IMandate>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
